...
class EditIndividualMemberAdminWidget extends StatefulWidget {
  ...
  EditIndividualMemberAdminWidget({this.members, this.index, this.currentGroupId});

  @override
  _EditIndividualMemberAdminWidgetState createState() => _EditIndividualMemberAdminWidgetState(members, index, currentGroupId);
}

class _EditIndividualMemberAdminWidgetState extends State<EditIndividualMemberAdminWidget> {
